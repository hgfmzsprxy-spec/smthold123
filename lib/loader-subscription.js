import { createScopedLicenseClient, normalizeLicenseStatus } from "./loader-redeem";

const LICENSE_SELECT =
  "id, license_key, status, activated_at, expires_at, duration_value, duration_unit, discord_auth_user_id, discord_user_id, discord_username";
...
export function computeSubscriptionMetrics(license) {
  ...
  const isExpired = remainingMs === 0 && Boolean(expiresAt);
