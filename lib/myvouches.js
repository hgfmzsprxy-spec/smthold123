const MYVOUCHES_PROFILE_SLUG =
  process.env.MYVOUCHES_PROFILE_SLUG || process.env.NEXT_PUBLIC_MYVOUCHES_PROFILE_SLUG || "phantom-cheatscom";
const MYVOUCHES_API_URL = `https://myvouch.es/api/${MYVOUCHES_PROFILE_SLUG}/vouches`;
