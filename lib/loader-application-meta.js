...
const PUBLIC_META_SELECT_ATTEMPTS = [
  "id, app_id, version, status, download_updated_at, updated_at, created_at",
  "app_id, version, status, download_updated_at, updated_at, created_at",
  "id, app_id, version, status, download_updated_at, created_at",
  "app_id, version, status, download_updated_at, created_at",
  "id, app_id, version, status, updated_at, created_at",
  "app_id, version, status, updated_at, created_at",
...
const PRIVATE_META_SELECT_ATTEMPTS = [
  "id, app_id, version, status, download_updated_at, created_at, download_file_name, download_file_type, download_file_size, download_file_sha256, download_file_data_base64",
  "id, app_id, version, status, download_updated_at, download_file_name, download_file_type, download_file_size, download_file_sha256, download_file_data_base64",
  "id, app_id, version, status, created_at, download_file_name, download_file_type, download_file_size, download_file_sha256, download_file_data_base64",
  "id, app_id, version, status, download_file_name, download_file_type, download_file_size, download_file_sha256, download_file_data_base64",
