...
export const kbmAimAssistFeatures = [
  {
    ...
    groups: [
      {
        ...
        items: [
          ...
          "Mouse & keyboard to controller mapping",
          "Low-latency raw input hooks",
          "Separate X/Y sensitivity",
          "Invert X / Invert Y",
          "Custom mouse button mapping (LMB / RMB / MMB)",
        ],
      },
      {
        title: "Stick & Movement",
        items: [
          "Double movement for fast flicks",
          "Acceleration & deceleration timing",
          "Dead zone dial (0–100)",
          "Noise filter dial (0–100)",
          "Linear / Exponential response curve",
          "Sync with Windows mouse DPI & sensitivity",
          "Fortnite mode (mouse look + WASD on pad)",
        ],
      },
    ],
  },
    ...
    groups: [
      {
        title: "Pad Mapping",
        items: [
          "Full Xbox 360 button remapping",
          "Keyboard keys to pad buttons",
          "Mouse buttons to pad triggers",
          "Scroll wheel support",
          "Movement keys (WASD) binding",
        ],
      },
    ],
  },
    ...
    groups: [
      {
        title: "Sticky Aim",
        items: [
          "Enable / Disable sticky aim",
          "ADS-only mode (RMB / LT)",
          "Strength (1–25)",
          "Smoothness (1–100)",
          "Max pull cap (1–25)",
        ],
      },
      {
        ...
        items: [
          "Enable / Disable recoil reducer",
          "Strength (1–100)",
          "Vertical compensation scale (1–100)",
        ],
      },
    ],
  },
  {
    ...
    groups: [
      {
        title: "Bunny Hop",
        items: ["Enable / Disable bunny hop", "Custom trigger key"],
      },
      {
...
export const productFeaturesBySlug = {
  "kbm-aim-assist": kbmAimAssistFeatures,
