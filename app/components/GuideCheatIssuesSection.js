    ...
    issues: [
      {
        ...
        explain:
          "After a successful load the menu can start open or closed. When closed, clicks go through to the game.",
      ...
      },
      {
        ...
        explain:
          "The overlay follows the game window. Exclusive fullscreen and other overlays often break alignment.",
