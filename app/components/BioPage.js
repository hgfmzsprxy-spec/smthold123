...
import { hasActiveUserActivation, markBioAutoplayGesture, unlockBioPageAudio } from "../../lib/bio-autoplay";
import { isBioBackgroundAudioPrimed } from "../../lib/bio-background-prime";
            ...
            <article className={`${styles.importantCard} ${styles.resellerCard}`}>
              ...
              <div className={styles.resellerFooter}>
                <a
                  ...
                  className={`${styles.resellerActionButton} ${styles.appealButton}`}
                >
                  <DiscordIcon />
                  Appeal
                </a>
