...
import {
  writeAdminNotificationWebhookSettings,
} from "../../../../lib/admin-notification-webhook";
...
async function requireWebhookAdmin(request) {
...
export async function POST(request) {
  try {
    const gate = await requireWebhookAdmin(request);
...
export async function PUT(request) {
  try {
    ...
    const updated = await writeAdminNotificationWebhookSettings({
